...
def optimize_pose_colmap(outputs: Path, 
    ...
    for i in range(n_ba_iterations):
        ...
        BA_cmd = f'colmap bundle_adjuster --BundleAdjustment.fix_coord_system 1 --BundleAdjustment.refine_focal_length 0 --BundleAdjustment.refine_principal_point 0 --BundleAdjustment.refine_extra_params 0 --input_path {colmap_sparse} --output_path {colmap_ba}'
        os.system(BA_cmd)
