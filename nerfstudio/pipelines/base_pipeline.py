...
class VanillaPipeline(Pipeline):
    ...
    def __init__(
        ...
        if (
            ...
            if self.datamanager.train_dataparser_outputs.metadata.get("points3D_pcd") is not None:
                seed_pts.append(self.datamanager.train_dataparser_outputs.metadata["points3D_pcd"])
